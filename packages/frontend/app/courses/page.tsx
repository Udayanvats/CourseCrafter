...
export default function Courses() {
  ...
  function searchCourse(query: string) {
    const filteredCourses = globalCourses.filter(course => course.title.toLowerCase().includes(query.toLowerCase()))
        ...
        <div className=" px-4 mt-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex mt-3 items-center min-w-xl ">
              ...
              }} className=" rounded-full bg-gray-800 w-[700px] max-w-xl focus:outline-none" placeholder="Search..." />
              <button onClick={()=>{
